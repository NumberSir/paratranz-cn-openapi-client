...
class Term(BaseModel):
    ...
    case_sensitive: Optional[StrictBool] = Field(default=None, description="术语匹配时是否大小写敏感", alias="caseSensitive")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "updatedBy", "pos", "uid", "term", "translation", "note", "project", "variants", "caseSensitive"]
    ...
    def pos_validate_enum(cls, value):
        ...
        if value not in set(['noun', 'verb', 'adj', 'adv']):
