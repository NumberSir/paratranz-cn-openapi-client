...
class BatchOperateStringsRequest(BaseModel):
    """
    BatchOperateStringsRequest
    """ # noqa: E501
    op: Optional[StrictStr] = Field(default=None, description="操作类型，update - 更新，delete - 删除")
    id: Optional[List[StrictInt]] = Field(default=None, description="需要操作的词条的id")
    stage: Optional[Stage] = Stage.NUMBER_0
    translation: Optional[StrictStr] = Field(default=None, description="词条翻译")
    __properties: ClassVar[List[str]] = ["op", "id", "stage", "translation"]
    ...
    def op_validate_enum(cls, value):
        ...
        if value not in set(['update', 'delete']):
            raise ValueError("must be one of enum values ('update', 'delete')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "op": obj.get("op"),
            "id": obj.get("id"),
            "stage": obj.get("stage") if obj.get("stage") is not None else Stage.NUMBER_0,
