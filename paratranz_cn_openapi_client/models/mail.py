...
class Mail(BaseModel):
    ...
    var_from: Optional[StrictInt] = Field(default=None, description="发送者的UID", alias="from")
    from_user: Optional[User] = Field(default=None, description="发送者的用户信息", alias="fromUser")
    to: Optional[StrictInt] = Field(default=None, description="接收者的UID")
    to_user: Optional[User] = Field(default=None, description="发送者的用户信息", alias="toUser")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "fromUser": User.from_dict(obj["fromUser"]) if obj.get("fromUser") is not None else None,
            "to": obj.get("to"),
            "toUser": User.from_dict(obj["toUser"]) if obj.get("toUser") is not None else None,
