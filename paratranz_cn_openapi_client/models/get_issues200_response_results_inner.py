...
class GetIssues200ResponseResultsInner(BaseModel):
    ...
    replied_at: Optional[datetime] = Field(default=None, description="最后回复时间", alias="repliedAt")
    ...
    last_edit: Optional[StrictInt] = Field(default=None, description="最后编辑者的 uid", alias="lastEdit")
    refer: Optional[List[Optional[StrictInt]]] = Field(default=None, description="在内容中提到（@）的用户的uid列表，如 `[1, 2, 3]`")
