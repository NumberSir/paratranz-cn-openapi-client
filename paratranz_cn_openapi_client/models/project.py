...
class Project(BaseModel):
    ...
    created_at: Optional[datetime] = Field(default=None, description="项目创建时间", alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, description="项目修改时间", alias="updatedAt")
