...
class TermHistory(BaseModel):
    ...
    var_field: Optional[StrictStr] = Field(default=None, description="修改的字段", alias="field")
    ...
    def operation_validate_enum(cls, value):
        ...
        if value not in set(['translate', 'edit', 'reset', 'dispute', 'review', 'rollback', 'lock', 'hide']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "target": TermHistoryTarget.from_dict(obj["target"]) if obj.get("target") is not None else None,
