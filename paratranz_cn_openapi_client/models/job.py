...
class Job(BaseModel):
    ...
    started_at: Optional[datetime] = Field(default=None, description="任务开始时间", alias="startedAt")
    finished_at: Optional[datetime] = Field(default=None, description="任务完成时间", alias="finishedAt")
    scheduled_at: Optional[datetime] = Field(default=None, description="任务定时启动时间", alias="scheduledAt")
