...
from paratranz_cn_openapi_client.rest import RESTResponseType
...
class StringsApi:
    ...
    async def batch_operate_strings(
        ...
        :type project_id: int
        :param batch_operate_strings_request: (required)
        :type batch_operate_strings_request: BatchOperateStringsRequest
        ...
        _param = self._batch_operate_strings_serialize(
            project_id=project_id,
            batch_operate_strings_request=batch_operate_strings_request,
    ...
    def _batch_operate_strings_serialize(
        self,
        project_id,
        batch_operate_strings_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if batch_operate_strings_request is not None:
            _body_params = batch_operate_strings_request
    ...
    async def get_strings(
        ...
        stage: Annotated[Optional[Stage], Field(description="筛选词条状态")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
