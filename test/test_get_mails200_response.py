...
class TestGetMails200Response(unittest.TestCase):
    """GetMails200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMails200Response:
        """Test GetMails200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMails200Response`
        """
        model = GetMails200Response()
        if include_optional:
            return GetMails200Response(
                page = 1,
                page_size = 50,
                row_count = 1,
                page_count = 1,
                results = [
                    paratranz_cn_openapi_client.models.mail.Mail(
                        id = 1001, 
                        ...
                        to = null, 
                        to_user = null, 
                        content = '私信内容 [链接](https://paratranz.cn)', 
                        html = '私信内容 <a href="https://paratranz.cn">链接</a>', 
                        status = 56, )
                    ]
            )
        else:
    ...
    def testGetMails200Response(self):
        """Test GetMails200Response"""
