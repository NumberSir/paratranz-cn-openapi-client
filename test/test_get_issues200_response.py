...
class TestGetIssues200Response(unittest.TestCase):
    """GetIssues200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIssues200Response:
        """Test GetIssues200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIssues200Response`
        """
        model = GetIssues200Response()
        if include_optional:
            return GetIssues200Response(
                ...
                open_count = 5,
                results = [
                    paratranz_cn_openapi_client.models.get_issues_200_response_results_inner.getIssues_200_response_results_inner(
    ...
    def testGetIssues200Response(self):
        """Test GetIssues200Response"""
