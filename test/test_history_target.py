...
class TestHistoryTarget(unittest.TestCase):
    """HistoryTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoryTarget:
        """Test HistoryTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistoryTarget`
        """
        model = HistoryTarget()
        if include_optional:
