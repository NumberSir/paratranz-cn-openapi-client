...
class TestCreateIssueRequest(unittest.TestCase):
    """CreateIssueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIssueRequest:
        """Test CreateIssueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIssueRequest`
        """
    ...
    def testCreateIssueRequest(self):
        """Test CreateIssueRequest"""
