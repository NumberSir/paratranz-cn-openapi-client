...
class TestGetFileRevisions200Response(unittest.TestCase):
    """GetFileRevisions200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFileRevisions200Response:
        """Test GetFileRevisions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFileRevisions200Response`
        """
        model = GetFileRevisions200Response()
        if include_optional:
            return GetFileRevisions200Response(
                page = 1,
                page_size = 50,
                row_count = 1,
                page_count = 1,
                results = [
                    paratranz_cn_openapi_client.models.revision.Revision(
                        id = 1001, 
                        created_at = '2021-01-11T03:19:52.818Z', 
                        name = 'common/countries/Ming.txt', 
                        filename = 'Ming.txt', 
                        type = 'create', 
                        file = 2, 
                        uid = 18, 
                        ...
                        update = 20, 
                        remove = 1, 
                        hash = 'c7a8e115432e30dc529025a45824baec', 
                        force = True, 
                        incremental = False, )
                    ]
            )
    ...
    def testGetFileRevisions200Response(self):
        """Test GetFileRevisions200Response"""
