...
class TestStringItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StringItem:
        """Test StringItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StringItem`
        """
        model = StringItem()
        if include_optional:
            return StringItem(
