...
class TestEditMemberRequest(unittest.TestCase):
    """EditMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMemberRequest:
        """Test EditMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMemberRequest`
        """
        model = EditMemberRequest()
        if include_optional:
    ...
    def testEditMemberRequest(self):
        """Test EditMemberRequest"""
