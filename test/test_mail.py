...
class TestMail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Mail:
        """Test Mail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Mail`
        """
        model = Mail()
        if include_optional:
            return Mail(
                ...
                var_from = 18,
                from_user = paratranz_cn_openapi_client.models.user.User(
                    id = 18, 
                    created_at = '2021-01-11T03:19:52.818Z', 
                    ...
                    points = 1.337, ),
                to = 18,
                to_user = paratranz_cn_openapi_client.models.user.User(
                    id = 18, 
                    created_at = '2021-01-11T03:19:52.818Z', 
                    updated_at = '2021-01-11T03:19:52.818Z', 
                    last_visit = null, 
