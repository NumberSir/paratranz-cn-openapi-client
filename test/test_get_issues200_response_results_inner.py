...
class TestGetIssues200ResponseResultsInner(unittest.TestCase):
    """GetIssues200ResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIssues200ResponseResultsInner:
        """Test GetIssues200ResponseResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIssues200ResponseResultsInner`
        """
        model = GetIssues200ResponseResultsInner()
        if include_optional:
            return GetIssues200ResponseResultsInner(
                subscribers = [1,18,1440],
                children_count = 3,
                replied_at = '2021-01-11T03:19:52.818Z',
                id = 1001,
    ...
    def testGetIssues200ResponseResultsInner(self):
        """Test GetIssues200ResponseResultsInner"""
