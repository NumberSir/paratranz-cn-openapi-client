...
class TestSaveFileRequest(unittest.TestCase):
    """SaveFileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveFileRequest:
        """Test SaveFileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveFileRequest`
        """
