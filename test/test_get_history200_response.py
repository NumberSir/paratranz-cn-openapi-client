    ...
    def make_instance(self, include_optional) -> GetHistory200Response:
        ...
        if include_optional:
            return GetHistory200Response(
                ...
                page_count = 1,
                results = [
                    paratranz_cn_openapi_client.models.history.History(
                        id = 56, 
                        created_at = '2021-01-11T03:19:52.818Z', 
                        field = 'translation', 
                        uid = 18, 
                        user = paratranz_cn_openapi_client.models.user.user(), 
                        tid = 332315, 
                        from = '这是上帝的意志！', 
                        to = '这是上帝的旨意！', 
                        target = {"key": "aaa.bbb", "stage": 1, "original": "It was the will of God!", "translation": "这是上帝的旨意！"}, 
                        operation = 'edit', )
                    ]
            )
        else:
