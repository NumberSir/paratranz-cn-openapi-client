...
class TestGetStrings200Response(unittest.TestCase):
    """GetStrings200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStrings200Response:
        """Test GetStrings200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStrings200Response`
        """
        model = GetStrings200Response()
        if include_optional:
            return GetStrings200Response(
                page = 1,
                page_size = 50,
                row_count = 1,
                page_count = 1,
                results = [
                    paratranz_cn_openapi_client.models.string_item.StringItem(
                        id = 1042, 
                        created_at = '2021-01-11T03:19:52.818Z', 
                        updated_at = '2021-01-11T03:19:52.818Z', 
                        key = 'unique_key_of_string', 
                        original = 'This is source text', 
                        translation = '这是一段翻译', 
                        file = paratranz_cn_openapi_client.models.file.file(), 
                        file_id = 56, 
                        stage = 1, 
                        project = 56, 
                        uid = 56, 
    ...
    def testGetStrings200Response(self):
        """Test GetStrings200Response"""
