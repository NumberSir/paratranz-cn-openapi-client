...
class TestBatchOperateStringsRequest(unittest.TestCase):
    """BatchOperateStringsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchOperateStringsRequest:
        """Test BatchOperateStringsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchOperateStringsRequest`
        """
        model = BatchOperateStringsRequest()
        if include_optional:
            return BatchOperateStringsRequest(
                op = 'update',
                id = [1,2,3,4],
                stage = 1,
                translation = '这是一条翻译'
    ...
    def testBatchOperateStringsRequest(self):
        """Test BatchOperateStringsRequest"""
