...
class TestSaveUserRequest(unittest.TestCase):
    """SaveUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveUserRequest:
        """Test SaveUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveUserRequest`
        """
        ...
        if include_optional:
            return SaveUserRequest(
                nickname = '机智的布鲁斯',
                bio = '24岁，是站长',
                avatar = 'https://static.paratranz.cn/media/xxxxxaaaaabbbbb'
            )
        else:
            return SaveUserRequest(
        )
