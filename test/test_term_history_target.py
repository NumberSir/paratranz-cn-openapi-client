...
class TestTermHistoryTarget(unittest.TestCase):
    """TermHistoryTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TermHistoryTarget:
        """Test TermHistoryTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TermHistoryTarget`
        """
        model = TermHistoryTarget()
        if include_optional:
            return TermHistoryTarget(
                pos = '',
                term = '',
                translation = '',
                note = '',
    ...
    def testTermHistoryTarget(self):
        """Test TermHistoryTarget"""
