...
class TestGetTermHistory200Response(unittest.TestCase):
    """GetTermHistory200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTermHistory200Response:
        """Test GetTermHistory200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTermHistory200Response`
        """
        model = GetTermHistory200Response()
        if include_optional:
            return GetTermHistory200Response(
                page = 1,
                page_size = 50,
                row_count = 1,
                page_count = 1,
                results = [
                    paratranz_cn_openapi_client.models.term_history.TermHistory(
                        id = 56, 
                        ...
                        from = '苹果', 
                        to = '香蕉', 
                        target = paratranz_cn_openapi_client.models.term_history_target.TermHistory_target(
                            pos = '', 
                            term = '', 
                            translation = '', 
                            note = '', 
    ...
    def testGetTermHistory200Response(self):
        """Test GetTermHistory200Response"""
