...
class TestOperateIssueRequest(unittest.TestCase):
    """OperateIssueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperateIssueRequest:
        """Test OperateIssueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperateIssueRequest`
        """
        model = OperateIssueRequest()
        if include_optional:
            return OperateIssueRequest(
                op = 'reply|subscribe|unsubscribe',
                content = '正在回复讨论'
            )
        else:
            return OperateIssueRequest(
    ...
    def testOperateIssueRequest(self):
        """Test OperateIssueRequest"""
