...
class TestTermsApi(unittest.TestCase):
    ...
    def test_create_term(self) -> None:
    ...
    def test_delete_term(self) -> None:
    ...
    def test_import_terms(self) -> None:
        """Test case for import_terms

        批量导入术语
        """
        pass

    def test_save_term(self) -> None:
        """Test case for save_term
